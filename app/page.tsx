...
export default function HomePage() {
  return (
    <main className="bg-[#0d1117] text-gray-100 ">

      {/* HEADER SECTION CON BACKGROUND */}
      <section className="relative flex flex-col items-center justify-center text-center mb-24 overflow-hidden py-32">
        ...
        {/* Content */}
        <div className="relative z-10 inset-1/8">
          ...
          <p className="max-w-3xl text-white text-xl leading-relaxed mb-12 py-14">
            Desarrollador Full-Stack con fuerte enfoque en frontend. Apasionado
            por la arquitectura limpia, el rendimiento y la experiencia de
            usuario. Actualmente lidero el desarrollo de una plataforma SaaS
            multi-tenant para e-commerce, basada en Laravel y Next.js. Siempre
            abierto a nuevos retos donde pueda aportar valor con código claro,
